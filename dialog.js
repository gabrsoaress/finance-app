(function() {
  const css = `
    ...
    .custom-toast-item {
      ...
      padding: 16px 20px; width: max-content; max-width: 90vw;
    ...
    .custom-toast-item.closing { animation: slideUpFade 0.3s forwards; }
    ...
    .custom-toast-item.error { background: linear-gradient(135deg, #fff0f0 0%, #ffffff 100%); }
    .custom-toast-item.warning { background: linear-gradient(135deg, #fff8eb 0%, #ffffff 100%); }
    .custom-toast-item.success { background: linear-gradient(135deg, #ebfbee 0%, #ffffff 100%); }
    .custom-toast-item.info { background: linear-gradient(135deg, #f0f7ff 0%, #ffffff 100%); }
    .custom-toast-item .custom-dialog-icon { width: 32px; height: 32px; flex-shrink: 0; }
    .custom-toast-item .custom-dialog-icon svg { width: 16px; height: 16px; }
    .custom-toast-content { display: flex; flex-direction: column; padding-right: 24px; }
    .custom-toast-title { font-size: 15px; font-weight: 600; color: #1f2937; margin: 0 0 2px 0; font-family: inherit; }
    .custom-toast-message { font-size: 13px; color: #6b7280; margin: 0; font-family: inherit; }
    .custom-toast-close {
      position: absolute; top: 14px; right: 14px; background: none; border: none;
      color: #9ca3af; cursor: pointer; padding: 4px; border-radius: 4px; display: flex; align-items: center; justify-content: center; transition: all 0.2s;
    }
    .custom-toast-close:hover { background: rgba(0,0,0,0.05); color: #4b5563; }
  `;
  ...
  window.CustomDialog = {
    ...
    toast: function(message, title = "Notificação", type = "info", durationMs = 4000) {
